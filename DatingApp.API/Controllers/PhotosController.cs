...
namespace DatingApp.API.Controllers
{
    ...
    public class PhotosController : ControllerBase
    {
        ...
        {
            var nameIdentifier = int.Parse(User.FindFirst(ClaimTypes.NameIdentifier).Value);
            if (userId != nameIdentifier)
            {
                return Unauthorized();
            }
            ...
            if (await _repo.SaveAll())
            {
                ...
                return CreatedAtRoute(
                    "GetPHoto", new { userId = userId, id = photo.Id }, photoToReturn
                    );
            }
